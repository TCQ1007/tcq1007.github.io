<template>
  <div style="background: #0a0e27; min-height: 100vh; color: #e2e8f0;">
    <!-- Hero Section -->
    <section style="background: linear-gradient(135deg, #1a202c 0%, #2d3748 50%, #4a5568 100%); color: #f7fafc; padding: 4rem 0; text-align: center; position: relative; overflow: hidden;">
      <!-- 技术背景装饰 -->
      <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; opacity: 0.1;">
        <div style="position: absolute; top: 20%; left: 10%; width: 100px; height: 100px; border: 2px solid #63b3ed; border-radius: 50%; animation: float 6s ease-in-out infinite;"></div>
        <div style="position: absolute; top: 60%; right: 15%; width: 80px; height: 80px; border: 2px solid #68d391; transform: rotate(45deg); animation: float 8s ease-in-out infinite reverse;"></div>
        <div style="position: absolute; bottom: 30%; left: 20%; width: 60px; height: 60px; border: 2px solid #f6ad55; border-radius: 10px; animation: float 7s ease-in-out infinite;"></div>
      </div>
      ...
      <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem; position: relative; z-index: 1;">
        ...
        <div style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
          ...
          <span style="padding: 0.5rem 1rem; background: rgba(104, 211, 145, 0.2); border: 1px solid #68d391; border-radius: 20px; font-size: 0.875rem; color: #68d391;">
            ⚡ 高性能
          </span>
    ...
    <div style="max-width: 1200px; margin: 0 auto; padding: 3rem 2rem;">
      ...
      <div v-else-if="error" style="text-align: center; padding: 3rem 0;">
        <div style="padding: 2rem; background: rgba(245, 101, 101, 0.2); border: 1px solid #f56565; border-radius: 8px; max-width: 500px; margin: 0 auto;">
      ...
      <div v-else-if="filteredArticles && filteredArticles.length > 0">
        <h2 style="font-size: 1.75rem; font-weight: 700; color: #ffffff; margin-bottom: 2rem; text-align: center; text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
          ...
          <span style="font-size: 1rem; color: #ffffff; font-weight: 500; margin-left: 0.5rem; opacity: 0.8;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 2rem;">
          ...
          >
            <!-- 分类标签 -->
            <div style="position: absolute; top: 1rem; right: 1rem; padding: 0.5rem 1rem; background: linear-gradient(45deg, #63b3ed, #68d391); border-radius: 20px; font-size: 0.75rem; font-weight: 600; color: #1a202c;">
            ...
            <div style="padding: 2rem;">
              ...
              <h3 style="font-size: 1.25rem; font-weight: 700; color: #ffffff; margin-bottom: 1rem; line-height: 1.4;">
                <NuxtLink
                  ...
                  @mouseover="$event.target.style.color = '#63b3ed'"
